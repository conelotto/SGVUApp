...
(function ($) {
   ...
   $.fn.uploadFile = function (options) {
      ...
      this.reset = function (removeStatusBars) {
         ...
         obj.selectedFiles = 0;
         obj.errorLog.html("");
         obj.responses = []; //Daniel Quispe: Para inicializar la propiedad "responses".
      ...
      //Daniel Quispe: Agregado para obtener los Nombres de los archivos (Nombre del archivo, Nombre generado)
      this.getNombreArchivos = function () {
         var listaNombres = [];

         for (i = 0; i < this.responses.length; i++) {
            var archivo = this.responses[i];
            listaNombres.push(archivo[0]);
         }
               ...
               if (s.showStatusAfterSuccess) {
                  ...
                  if (s.showDelete) {
                     ...
                     pd.del.click(function () {
                        ...
                        //Daniel Quispe: Agregado para eliminar el archivo de la propiedad "responses"
                        var i = obj.responses.indexOf(data);
                        if (i > -1) removedItems = obj.responses.splice(i, 1);
