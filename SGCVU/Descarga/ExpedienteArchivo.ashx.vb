...
Public Class ExpedienteArchivo
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            Dim ExpedientrArchivo As New BE_ExpedienteArchivo
            Dim _liBeExpedienteArchivo As New List(Of BE_ExpedienteArchivo)
            Dim _BEExpedienteArchivo As New BE_ExpedienteArchivo
            _BEExpedienteArchivo.intExpedienteId = _Filter.intExpedienteId
            _liBeExpedienteArchivo = clsExpediente.fn_Select_ExpedienteArchivo(_BEExpedienteArchivo) ' clsMaquina.fn_Select_MaquinaArchivo(_BEExpedienteArchivo) 'clsApoyo_Flujo.fn_Select_ApoyoFlujo_Washout_ByKey(_Filter)
